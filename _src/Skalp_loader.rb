...
exit_skalp
  ...
  if Time.now()> EXPIRE_DATE
    ...
    require 'Skalp_Skalp/Skalp_html_inputbox'
    require 'Skalp_Skalp/Skalp_box_section'
    require 'Skalp_Skalp/Skalp_box_section_tool'
    require 'Skalp_Skalp/Skalp_UI'
    require 'Skalp_Skalp/Skalp_lib2'
    require 'Skalp_Skalp/Skalp_geom2'
    require 'Skalp_Skalp/Skalp_material_dialog'
    require 'Skalp_Skalp/Skalp_paintbucket'
