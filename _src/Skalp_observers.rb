module Skalp
  ...
  class SkalpLicenseObserver < Sketchup::AppObserver
    def onQuit
      if Sketchup.read_default('Skalp', 'guid') && File.exist?(Sketchup.find_support_file("Plugins")+"/Skalp_Skalp/Skalp.lic") && Skalp.check_license_type_on_server(Sketchup.read_default('Skalp', 'guid')) == 'network'
