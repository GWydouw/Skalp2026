...
module Skalp::Shellwords
  autoload :Bourne, 'Skalp_Skalp/shellwords/bourne'
  autoload :CmdExe, 'Skalp_Skalp/shellwords/cmd_exe'
  autoload :Msvcrt, 'Skalp_Skalp/shellwords/msvcrt'
  autoload :MsvcrtByCmdExe, 'Skalp_Skalp/shellwords/msvcrt_by_cmd_exe'
