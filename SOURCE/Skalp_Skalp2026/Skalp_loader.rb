...
exit_skalp
  ...
  def self.remove_license
    FileUtils.remove_entry(Sketchup.find_support_file("Plugins")+"/Skalp_Skalp2026/Skalp.lic", true) if File.exist?(Sketchup.find_support_file("Plugins")+"/Skalp_Skalp2026/Skalp.lic")
  end
  ...
  if File.exist?(Sketchup.find_support_file("Plugins")+"/Skalp_Skalp2026/Skalp.lic") && (Sketchup.read_default('Skalp', 'guid') == nil || Sketchup.read_default('Skalp', 'id') == nil)
    remove_license
  end

  FileUtils.remove_entry(Sketchup.find_support_file("Plugins") + '/Skalp_Skalp2026/Skalp_geom.rbs', true) if File.exist?(Sketchup.find_support_file("Plugins")+ '/Skalp_Skalp2026/Skalp_geom.rbs')
  FileUtils.remove_entry(Sketchup.find_support_file("Plugins") + '/Skalp_Skalp2026/Skalp_lib.rbs', true) if File.exist?(Sketchup.find_support_file("Plugins")+ '/Skalp_Skalp2026/Skalp_lib.rbs')
  FileUtils.remove_entry(Sketchup.find_support_file("Plugins") + '/Skalp_Skalp2026/Skalp_isolate.rbs', true) if File.exist?(Sketchup.find_support_file("Plugins") + '/Skalp_Skalp2026/Skalp_isolate.rbs')
  ...
  def self.encoderErrorCheck
    ...
    if encoderError == 9999
      ...
      Sketchup::require 'Skalp_Skalp2026/Skalp_lic' if File.exist?(Sketchup.find_support_file("Plugins")+"/Skalp_Skalp2026/Skalp.lic")
      return false
    else
  ...
  if Time.now()> EXPIRE_DATE
    ...
    def self.install_C
      ...
      begin
        ...
        require "Skalp_Skalp2026/Skalp_debugger_SkalpC.rb" if defined?(SKALPDEBUGGER) && SKALPDEBUGGER
    ...
    require 'Skalp_Skalp2026/Skalp_dwg_export_dialog.rb'
    require 'Skalp_Skalp2026/Skalp_cad_converter.rb'
    require 'Skalp_Skalp2026/Skalp_white_mode.rb'
    ...
    def self.startup_check(start_tool = nil)
      ...
      if license_version < 2 && File.exist?(Sketchup.find_support_file("Plugins")+"/Skalp_Skalp2026/Skalp.lic") then
      ...
      return if Sketchup.read_default('Skalp', 'license_version').to_i < 2 && File.exist?(Sketchup.find_support_file("Plugins")+"/Skalp_Skalp2026/Skalp.lic")

      #check if network version?
      guid = Sketchup.read_default('Skalp', 'guid')
      if guid && !File.exist?(Sketchup.find_support_file("Plugins")+"/Skalp_Skalp2026/Skalp.lic")
