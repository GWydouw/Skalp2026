#a version of shellwords with windows support
#https://github.com/larskanis/shellwords.git

#require "shellwords/version"
require "rbconfig"


module Skalp::Shellwords
  autoload :Bourne, 'Skalp_Skalp2026/shellwords/bourne'
  autoload :CmdExe, 'Skalp_Skalp2026/shellwords/cmd_exe'
  autoload :Msvcrt, 'Skalp_Skalp2026/shellwords/msvcrt'
  autoload :MsvcrtByCmdExe, 'Skalp_Skalp2026/shellwords/msvcrt_by_cmd_exe'

  @@default_rule_set = case RbConfig::CONFIG['host_os']
    when /mingw|mswin/ then Skalp::Shellwords::Msvcrt
    else Skalp::Shellwords::Bourne
  end
