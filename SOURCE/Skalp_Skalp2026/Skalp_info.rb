module Skalp
  ...
  def self.show_info(active_menu, start_tool = nil, show_guid = false)
    ...
    @info_dialog.add_action_callback("license") { |webdialog, params|
      ...
      Skalp.write_classroom_settings if File.exist?(Sketchup.find_support_file("Plugins")+"/Skalp_Skalp2026/Skalp.lic") && license_type == 'CLASSROOM'
      #@info_dialog.close
    }
  ...
  def self.system_info
    ...
    add_string("License: " + license_type + " (" + guid + ")") if File.exist?(Sketchup.find_support_file("Plugins")+"/Skalp_Skalp2026/Skalp.lic") && guid
    add_string("")
