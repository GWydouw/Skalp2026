module Skalp
  ...
  def self.install_skalp
    begin
      Sketchup.install_from_archive(Sketchup.find_support_file("Plugins") + "/Skalp_Skalp2026_installer/Skalp.rbz")
  ...
  install_ready = Sketchup.find_support_file("Plugins") + "/Skalp_Skalp2026_installer/install_ready.skalp"
