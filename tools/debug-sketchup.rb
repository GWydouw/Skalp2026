...
# Debugging only possible in SketchUp 2014 && newer as debugger protocol was
# introduced for Ruby 2.0.
version = "20#{sketchup_version}"

debug_args = '-rdebug "ide port=7354"'
...
# We  start SketchUp with the special flag to make it connect to the
