...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/3.2.0/arm64-darwin")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/bmiller1/src/.conan/data/ruby/3.2.2g/sketchup/stable2/build/81af0175c5e02b8b4860be7e2fd8c6b69ae59f31")
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-mmacosx-version-min=11.7 -Wl,-undefined,dynamic_lookup"
  CONFIG["ALLOCA"] = ""
