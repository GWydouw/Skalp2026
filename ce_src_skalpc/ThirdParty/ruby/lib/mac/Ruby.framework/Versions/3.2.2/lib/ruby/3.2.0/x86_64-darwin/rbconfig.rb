...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/3.2.0/x86_64-darwin")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/bmiller1/src/.conan/data/ruby/3.2.2g/sketchup/stable2/build/e64bc735cdf4aa34cd052834ce7032b821929922")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/bmiller1/src/.conan/data/ruby/3.2.2g/sketchup/stable2/build/e64bc735cdf4aa34cd052834ce7032b821929922' '--with-openssl-dir=/Users/bmiller1/src/.conan/data/openssl/3.3.1/sketchup/stable2/package/ec4e67ea7e1288852230a9d73d24ad80f05d02e6' '--with-libyaml-dir=/Users/bmiller1/src/.conan/data/libyaml/0.2.5/_/_/package/6841fe8f0f22f6fa260da36a43a94ab525c7ed8d' '--with-libffi-dir=/Users/bmiller1/src/.conan/data/libffi/3.4.6/_/_/package/8a659aeafbc64e1549799b2ee77375f43ddc5111' '--disable-install-doc' '--disable-install-rdoc' '--enable-shared' '--enable-load-relative' '--with-static-linked-ext' '--without-debug' '--without-gdbm' '--without-gettext' '--without-irb' '--without-mkmf' '--without-rdoc' '--without-readline' '--without-tk' '--bindir=$${prefix}/bin' '--sbindir=$${prefix}/bin' '--libexecdir=$${prefix}/bin' '--libdir=$${prefix}/lib' '--includedir=$${prefix}/include' '--oldincludedir=$${prefix}/include' '--datarootdir=$${prefix}/share' '--build=x86_64-apple-darwin' '--host=aarch64-apple-darwin' 'build_alias=x86_64-apple-darwin' 'host_alias=aarch64-apple-darwin' 'cflags=-mmacosx-version-min=11.7' 'cxxflags=-mmacosx-version-min=11.7' 'LDFLAGS=-mmacosx-version-min=11.7'"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-mmacosx-version-min=11.7 -Wl,-multiply_defined,suppress -Wl,-undefined,dynamic_lookup"
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["ARFLAGS"] = "rcu "
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "Apple clang version 14.0.3 (clang-1403.0.22.14.1)\nTarget: x86_64-apple-darwin23.6.0\nThread model: posix\nInstalledDir: /Applications/Xcode_14.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin"
  CONFIG["CC_VERSION"] = "$(CC) --version"
  CONFIG["MJIT_CC"] = "clang"
  CONFIG["CSRCFLAG"] = ""
  CONFIG["COUTFLAG"] = "-o "
  CONFIG["OUTFLAG"] = "-o "
  ...
  CONFIG["GCC"] = "yes"
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-mmacosx-version-min=11.7"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -mmacosx-version-min=11.7 -fstack-protector-strong"
  CONFIG["CFLAGS"] = "-mmacosx-version-min=11.7 -O3 -fno-fast-math -ggdb3  -fdeclspec  -fno-common -pipe"
  ...
  CONFIG["build"] = "x86_64-apple-darwin"
  ...
  CONFIG["cxxflags"] = "-mmacosx-version-min=11.7"
  CONFIG["cppflags"] = ""
  CONFIG["cflags"] = "-mmacosx-version-min=11.7 -fdeclspec $(optflags) $(debugflags) $(warnflags)"
  CONFIG["MAKEDIRS"] = "mkdir -p"
  CONFIG["target_alias"] = ""
  CONFIG["host_alias"] = "$(target_alias)"
  CONFIG["build_alias"] = "x86_64-apple-darwin"
