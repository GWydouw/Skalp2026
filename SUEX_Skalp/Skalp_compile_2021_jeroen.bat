...
msbuild "Z:\SourceTree_repos\Skalp\Skalp_external_application\Skalp_external_application.sln"  /t:rebuild
msbuild "Z:\SourceTree_repos\Skalp\SUEX_Skalp\SkalpC_2.7.sln" /t:rebuild
pause
