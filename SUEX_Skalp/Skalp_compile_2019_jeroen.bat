...
msbuild "Z:\jeroentheuns\Dropbox\Sourcetree_repos\Skalp\Skalp_external_application\Skalp_external_application.sln"  /t:rebuild
msbuild "Z:\jeroentheuns\Dropbox\Sourcetree_repos\Skalp\SUEX_Skalp\SkalpC_2.5.sln" /t:rebuild
pause