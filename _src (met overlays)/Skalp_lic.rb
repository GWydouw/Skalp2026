module Skalp
  ...
  def self.license_type #FULL / TRIAL / EDU
    RGLoader::get_const("LICENSE_TYPE") if File.exist?(Sketchup.find_support_file("Plugins")+"/Skalp_Skalp/Skalp.lic")
  end
  ...
  def self.license_date
    RGLoader::get_const("license_date") if File.exist?(Sketchup.find_support_file("Plugins")+"/Skalp_Skalp/Skalp.lic")
  end

  def self.expire_date
    RGLoader::get_const("expire_date") if File.exist?(Sketchup.find_support_file("Plugins")+"/Skalp_Skalp/Skalp.lic")
  end
end